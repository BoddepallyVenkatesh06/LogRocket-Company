/*! forms2 2024-01-29  See forms2.js for license info */ ! function a(b, c, d) {
    function e(g, h) {
        if (!c[g]) {
            if (!b[g]) {
                            ...
                            D = function(a) {
                                if (a.error) F(a);
                                    ...
                                    if (a.followupStreamValue && window.AdobeDX && window.AdobeDX.conversationalForms) {
                                        ...
                                        var d = window.AdobeDX.conversationalForms(c);
                                        if (d.registerCallback && d.Enum && d.Enum.Events && d.Enum.Events.CONVERSATIONAL_FORMS_CLOSE && d.Enum.CallbackType && d.Enum.CallbackType.EVENT_LISTENER) {
                                            var e = {
                                                listenOn: [d.Enum.Events.CONVERSATIONAL_FORMS_CLOSE]
                                            };
                                            d.registerCallback(d.Enum.CallbackType.EVENT_LISTENER, function(b) {
                                                C(a)
                                            }, e)
                                        }
                                    } else C(a)
                    ...
                    V = function(b) {
                        var c = function(b) {
                                if (z.submitButton) {
                                    ...
                                    c.attr("disabled", "disabled"), a.ButtonSubmissionText && c.html(a.ButtonSubmissionText)
                                }
                                return U(), !1
                            },
                            e = x.validate();

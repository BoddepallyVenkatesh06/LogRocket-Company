...
(function(l) {
    if (!l.MunchkinTracker) {
        var h = l.document,
            ...
            k = null,
            m = null,
            W = l.navigator.cookieEnabled || h.hasOwnProperty("cookie") && (0 < h.cookie.length || -1 < (h.cookie = "testcookie=test; max-age=10000").indexOf.call(h.cookie, "testcookie=test;")),
            z = !1,
            A = [],
            L = null,
            X = function(b, a, c) {
            ...
            P = function(b, a, c, d, e) {
                ...
                f.useBeaconAPI && window.navigator && window.navigator.sendBeacon ?
                    window.navigator.sendBeacon(b) : (c = (new Date).getTime(), e = !e && !f.asyncOnly, 0 === a.indexOf("webevents/visitWebPage?") && (e = !1), V ? X(b, e, f.clickTime) : (new l.Image(1, 1)).src = b, L = c + f.clickTime)
            },
            Y = function() {
                var b;
                return function(a, c) {
            ...
            x = function(b, a, c, d) {
                ...
                if (z) {
                    ...
                    if (!k && e(m) && (a._mchId = m.id, a._mchTk = m.token, e(f.mkt_tok) && (a.mkt_tok = f.mkt_tok), e(f.wsInfo) && (a._mchWs =
                            f.wsInfo), "clickLink" === b && (a._mchCn = e(f.customName) ? f.customName : ""), a._mchHo = h, a._mchPo = p.port, e(a._mchRu) || (a._mchRu = s(p.pathname)), a._mchPc = l, a._mchVr = "163", e(h) && 0 !== h.length && "file:" !== l))
            ...
            R = function(b) {
                ...
                if (f && !a._mchDone) {
                    ...
                    a === h || a === l || "A" !== a.tagName && "AREA" !== a.tagName ? a = null : (c = a.href.replace(/^\s+|\s+$/g, ""), a = e(c) && 0 < c.length && 0 !== c.indexOf("#") && 0 !== c.indexOf(f +
                        "#") && 0 !== c.indexOf("javascript") && !F(a, "mchNoDecorate") ? a : null);
                    e(a) && !Y(b, a) && (d._mchHr = s(a.href), x("clickLink", d), l.mktoLinkTarget = a.href)
                }
            },
            B = function(b) {
                if (z) {
                    ...
                    if (e(c.id) || f.cookieAnon || b) {
                        if (c.id = k, e(c.token) || (e(f.visitorToken) && "VISITOR_MKTTOK_REPLACE" !== f.visitorToken ? c.token = f.visitorToken : c.token = "_mch-" + a + "-" + (new Date).getTime() + "-" + (Math.floor(9E4 * Math.random()) + 1E4)), c.store(f.cookieLifeDays,
                                "/", a, d), d && (c = w("_mkto_trk")), !d || e(c.id)) return m = c, Q(), c
                    } else return null
            ...
            N = function() {
                if (!z) {
                    ...
                    if (e(f._ecid)) v = f._ecid;
                        ...
                        for (var g = RegExp("AMCV_([A-Za-z0-9]+%40AdobeOrg)=([^;]+)", "g"), r, n = []; null !== (r = g.exec(h.cookie));) {
                            var q = decodeURIComponent(r[1]),
                                m;
                            e(a) && q !== a ||
                                null === (m = /MCMID(%7C|\|)([^%\|]+)/.exec(r[2])) || (r = /MCAAMLH-[^%\|]+(%7C|\|)([0-9]+)/.exec(r[2]), n.push(q + ":" + (e(r) ? r[2] : "") + ":" + m[2]))
                        }
                        v = n.join(";")
                    }
                    if (e(b)) f.apiOnly || (c._mchCn = e(f.customName) ? f.customName : "", d._mchHa = s(p.hash), d._mchRe = s(h.referrer), d._mchQp = s(p.search.substr(1).replace(/&/g, "__-__")), x("visitWebPage", c, d, !0));
                        ...
                        for (m = 0; m < d; m += 1)
                            if (F(c[m], "lpeRegForm"))
                                for (g = c[m].elements, n = g.length, a = 0; a < n; a += 1) "submit" !==
                                    g[a].type || F(g[a], "mchNoDecorate") || b.push(g[a]);
        ...
        (function(b) {
            ...
            var b = 0;
            if (e(h.links))
                for (b = 0; b < h.links.length; b += 1) u(h.links[b], "click",
                    R, !0)
        });

//@preserve v4.23.0+bb882a6693e5b
! function(e) {
    var t = {};
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        function(e) {
            e.HeapSideloadsCS = "heap_sideloads_cs", e.CsSideloadsHeap = "cs_sideloads_heap", e.HeapDrivesCS = "heap_drives_cs", e.MappingOnly = "mapping_only"
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.startNewCSSession = t.extendCSSession = t.createNewCSUser = t.shouldControlCs = t.getReplayId = t.identifyAurycSessionWithUserId = t.createAndIdentifyNewAurycSession = t.addSRParamToProps = t.getSessionReplayParams = t.getContentsquareParam = t.getContentsquareProperties = t.getAurycParam = t.getScreenDimensions = t.getLogrocketParam = t.STATUSES_TO_TRIGGER_CS_ACTIONS = void 0;
    var i = r(8),
        o = r(9);
    t.STATUSES_TO_TRIGGER_CS_ACTIONS = [i.HeapTagStatus.HeapSideloadsCS, i.HeapTagStatus.HeapDrivesCS];
    var a = function(e) {
        var t = function(t) {
            ...
            return encodeURIComponent(i + "/" + a + "/" + u + "/" + s + "/" + e)
        };
        try {
            var r = window,
                n = '';
        ...
        try {
            ...
            if (r) {
                var n = r.cspid,
                    ...
                    u = r.csuu,
                    s;
                e = "cs:" + encodeURIComponent(n + "/" + u + "/" + o + "/" + i + "/" + a)
            }
            return e
        } catch (e) {
            return ''
    ...
    var P = function(e) {
        ...
        try {
            for (var f = a(i.reverse()), p = f.next(); !p.done; p = f.next()) {
                ...
                if (h += _.length > 0 ? _.join(';') + ";" : '', (h += '|').length + c.length > u) {
                    l = !0;
                    break
                }
                c = h + c
    ...
    var F = function(e, r, n, i) {
        ...
        try {
            var c;
            W(o, r) !== s && (0, d.sample)(1e6, n, ['target-text-affected-by-heap-ignore', 1])
        } catch (e) {
    ...
    var k = I.Logger.build({
        ...
        addPageviewProperties, HEAP_VERSION = {
            "installedVersion": "4.23.0+bb882a6693e5b",
            "heapJsVersion": "4.23.0",
            "supportedUntil": "2024-08-29T16:59:50.948Z",
            "revisionId": "bb882a6693e5b"
        },
        HEAP_EXPERIMENT = {},
        SNAPSHOT_CONFIG = {},
    ...
    var R, M = 'https:' === document.location.protocol,
        ...
        U = Pe(),
        j = Ce('/h'),
        H = Ce('/api/add_user_properties_v3'),
        V = Ce('/api/telemetry'),
        D = 2e3,
        F, G = {},
        K = {},
    ...
    function ge() {
        var e, t;
        t = Fe(), lt(Xe()), e = s(t), i.isObject(e) && i.isObject(e.event_properties) && Je(gt(e.event_properties), Z, j, !0)
    }

    function _e() {
        if (W) return !1;
        var e;
        W = !0, window.top === window.self && A.getCookie(d.EV_COOKIE_NAME) && Ee();
        var t = i.pick(ft(), ['g', 'h', 'q', 'e']);
        return setTimeout((function() {
            try {
                $ = !0, _t(t), tt.startLoop(), st(It)
            } catch (e) {
    ...
    function we(e, t) {
        var r = function(n) {
            de(window, n.type, r), n !== e || se(n) || t(n)
        };
        fe(window, e.type, r)
    }
    ...
    function be(e) {
        var t;
        if (t = (e = e || window.event).target, (!_.getIEVersion() || t === e.currentTarget) && t && t.tagName && 'click' === e.type && (mt(e), ce(e))) {
            var r = t,
                n = function(e) {
                    var t = e.tagName.toLowerCase(),
            ...
            a ? Ae.push([e, o]) : u || e.metaKey || e.shiftKey || e.ctrlKey || e.altKey || we(e, (function() {
                ...
                if (function(e) {
                    ...
                    u && '_self' !== t(u).toLowerCase() ? u.match(/^_(parent|top)$/i) && Te(e, (function() {
                        window.open(a, u)
                    })) : Te(e, (function() {
    ...
    function Le() {
        var e;
        C.isHeapHandledWebview() && C.extendSessionHandler((new Date).getTime() + d.SESSION_COOKIE_EXPIRATION_IN_MS, wt()), e = A.getCookieName('ses_props'), A.setCookie(e, A.getCookie(e), d.SESSION_COOKIE_EXPIRATION_IN_MS)
    }
    ...
    function Ke(e) {
        ...
        try {
            ...
            try {
                ...
                xt('Error splitting idCookie.', e), r = l.generateNewContainer(c.generateId)
            }
        }
        if (!Ge(r.userId) && !i.isNull(r.userId)) try {
            r = JSON.parse(r.userId + '.0"}')
        } catch (e) {
            xt('Error parsing container.userId', e), r = l.generateNewContainer(c.generateId)
        }
    ...
    function Be() {
        var e, t;
        return t = (e = A.getCookie(A.getCookieName('id'))) ? Ke(e) : Y
    }
    ...
    function Xe() {
        ...
        var n = C.isHeapHandledWebview(),
            i = C.getWvIdContents();
        return e ? (Q = 2, t = Ke(e), r = n ? i.userId : t.userId, t.pageviewId = c.generateId(), A.getCookie(A.getCookieName('ses_props')) || (Q = 1, t.sessionId = n ? i.sessionId : c.generateId())) : (Q = 0, t = {
    ...
    function Ye(e, t) {
        var r = C.isHeapHandledWebview(),
            n = C.getWvIdContents();
        (e.identity || e.userId) && (e.pageviewId = c.generateId(), e.sessionId = r ? n.sessionId : c.generateId(), lt(e), A.setCookie(A.getCookieName('ses_props'), {}, -1), Me(e), _t(t))
    }
    ...
    function et(e, t, r) {
        ...
        if (e[0] && n) {
            var i = Ke(n),
                o = t,
                a;
            z + d.SESSION_COOKIE_EXPIRATION_IN_MS < (new Date).gt() ? (O.startNewCSSession(), Ye(i), o = Z) : O.extendCSSession(), z = (new Date).gt(), Je(e[0], o, j, !1, r);
            ...
            var e = [],
                ...
                o = function(e) {
                    ...
                    n = (e = e || window.event).target, u = y.getClassName(n), s = 'mouseup' === e.type ? 'click' : e.type, o = (l = y.getHierarchyForElement({
                        ...
                        recordData: Ut
                    })).hierarchyString, f = l.topFirstDecomposedHierarchy, t = me(s, o);
                    var p = (new Date).gt();
                ...
                l = function(e) {
                    var t, r;
                    t = O.addSRParamToProps(e.props), t = i.extend(t, q), e.type === d.MessageType.AutoTrack ? (t.k = (t.k || []).concat(w.encodePrimitiveKeysAndValuesAsArrayOfStrings(K)), t = i.extend(t, O.getScreenDimensions()), tt.queue(t)) : i.contains(d.HEAP_TRACK_CALL_MESSAGE_TYPES, e.type) ? (t.k = (t.k || []).concat(w.encodePrimitiveKeysAndValuesAsArrayOfStrings(i.extend({}, K, e.customProps))), e.type === d.MessageType.SourceTrack && (t.sprops = (t.sprops || []).concat(w.encodePrimitiveKeysAndValuesAsArrayOfStrings(e.sourceProps))), tt.queue(t)) : e.type === d.MessageType.Metadata ? (t.k = (t.k || []).concat(w.encodePrimitiveKeysAndValuesAsArrayOfStrings(i.extend({}, K))), t = i.extend(t, O.getScreenDimensions()), r = s(t), i.isObject(r) && i.isObject(r.event_properties) && Je(gt(r.event_properties), e.idParams, j, u(r.event_properties))) : tt.queue(e.props)
                },
                f = function(e) {
                    var t, r;
    ...
    function lt(e) {
        return rt.pushEventMessageSet(), window.heap.userId = e.userId, window.heap.identity = e.identity, Y = e, Z = ct(e)
    }
    ...
    function _t(e) {
        lt(Xe()), G = De(), addPageviewProperties(vt());
        var t = i.extend({}, ft(), e || {});
        ...
        rt.queueEventMessage(r), T.sample(1e4, Ut, ['secure', M]);
        try {
    ...
    function yt(e) {
        if (e && 'object' == typeof e && !Array.isArray(e)) {
            ...
            t > 0 && Ut('eventPropertiesTelemetry - added new properties', t), i.extend(G, e), He(G)
        } else _.canUseConsole() && console.warn('addEventProperties was called with an invalid argument')
    }

    function Et(e) {
        G = De(), Object.prototype.hasOwnProperty.call(G, e) && Ut('eventPropertiesTelemetry - removed properties', 1), delete G[e], He(G)
    }

    function St() {
        var e = De(),
            t = Object.keys(e).length;
        t && Ut('eventPropertiesTelemetry - removed properties', t), He(G = {})
    }

    function wt() {
        var e = A.getCookie(A.getCookieName('id')),
            t;
        return e ? Ke(e).sessionId : null
    }
    ...
    function Tt() {
        if (!C.isHeapHandledWebview()) {
            ...
            if (l.isIdentified(e)) {
                ...
                var t = c.generateId();
                e.userId = t, e.identity = null, e.oldIdentity = null, e.identityField = null, e.isIdentified = null, lt(e), Me(e), O.createAndIdentifyNewAurycSession(t), O.createNewCSUser(), Ye(e, {
                    z: 0
                })
    ...
    if (addPageviewProperties = function(e) {
        ...
        var At = a.getUserDefinedConfig();
        R = window._heapid ? heap.appid = window._heapid : heap.appid, qe(), A.cookiePathValid(At.cookiePath) && Re();
        var bt = heap,
            It = [],
            Ot = function(e) {
                var t, r, n, o, a;
                if ($)
                    if (i.isObject(e)) {
                        ...
                        if (n = w.requestStringBuilder(!1, xt), o = m.truncateKeysAndValuesOfObject(r, [], d.MAX_ATTRIBUTE_LENGTH), i.size(o)) {
                            ...
                            var u = H + '?' + Z + (a = a ? '&' + a : '') + '&st=' + (new Date).gt() + We(),
                                s;
                            new Image(1, 1).src = u
        ...
        if (window.heap = {
            ...
            }, st(bt), fe(window, 'beforeunload', pe, !0), fe(window, 'message', ve, !0), ['mousemove', 'mouseup', 'mousedown', 'keydown', 'keypress', 'keyup', 'mouseenter', 'scroll', 'resize', 'dblclick', 'touchstart', 'touchmove', 'touchend', 'touchcancel', 'pointerover', 'pointerenter', 'pointerdown', 'pointermove', 'pointerup', 'pointercancel', 'pointerout', 'pointerleave'].forEach((function(e) {
                try {
    ...
    function Mt() { /* globals markAsyncSourceLoaded, registerAsyncSource */
        (function() {
    ...
    function jt(e) {
        return V + "?a=" + R + '&' + e + '&st=' + (new Date).gt() + ze() + We()
    }
    ...
    (function(e, r) {
        (function() {
            var n, i = '3.10.1',
                ...
                J = {};
            J[L] = J[x] = J[U] = J[j] = J[H] = J[V] = J[D] = J[F] = J[G] = !0, J[E] = J[S] = J[M] = J[w] = J[T] = J[A] = J[b] = J[I] = J[O] = J[C] = J[N] = J[P] = J[k] = J[R] = !1;
            var Y = {};
            Y[E] = Y[S] = Y[M] = Y[w] = Y[T] = Y[L] = Y[x] = Y[U] = Y[j] = Y[H] = Y[O] = Y[C] = Y[N] = Y[k] = Y[V] = Y[D] = Y[F] = Y[G] = !0, Y[A] = Y[b] = Y[I] = Y[P] = Y[R] = !1;
            var Z = {
                    function: !0,
                    object: !0
                },
            ...
            function Ot(e, t, r) {
                var n = typeof e;
                return 'function' == n ? void 0 === t ? e : or(e, t, r) : null == e ? Yn : 'object' == n ? $t(e) : void 0 === t ? ri(e) : Wt(e, t)
            }
            ...
            function Ct(e, t, r, n, i, o, a) {
                ...
                if (s) {
                    ...
                    var c = be.call(e),
                        l = c == b;
                    if (c != C && c != E && (!l || i)) return Y[c] ? Rr(e, c, t) : i ? e : {};
                    if (pe(e)) return i ? e : {};
            ...
            function Kt(e, t, r) {
                if (null != e) {
                    e = Wr(e), void 0 !== r && r in e && (t = [r]);
                    for (var n = 0, i = t.length; null != e && n < i;) e = Wr(e)[t[n++]];
            ...
            function Xt(e, t, r, n, i, o, a) {
                var u = Pn(e),
                    ...
                    c = S,
                    l = S;
                u || ((c = be.call(e)) == E ? c = C : c != C && (u = jn(e))), s || ((l = be.call(t)) == E ? l = C : l != C && (s = jn(t)));
                var f = c == C && !pe(e),
                    d = l == C && !pe(t),
                    p = c == l;
                if (p && !u && !f) return Er(e, t, c);
                if (!i) {
            ...
            function $t(e) {
                ...
                if (1 == t.length && t[0][2]) {
                    var r = t[0][0],
                        n = t[0][1];
                    return function(e) {
                        return null != e && ((e = Wr(e))[r] === n && (void 0 !== n || r in e))
                    }
                }
                return function(e) {
                    return qt(e, t)
            ...
            function mr(e, t, r, n, i, o, a, u, s, c) {
                ...
                function _() {
                    ...
                    if (n && (E = ur(E, n, i)), o && (E = sr(E, o, a)), p || h) {
                        var S = _.placeholder,
                            w = ge(E, S);
                        if ((m -= w.length) < c) {
                            var T = u ? ht(u) : void 0,
                            ...
                            var N = [e, t, r, O, b, C, I, T, s, A],
                                P = mr.apply(void 0, N);
                            return jr(e) && Kr(P, N), P.placeholder = S, P
                        }
                    }
                    var k = f ? r : this,
                        R = d ? k[e] : e;
                    return u && (E = Gr(E, u)), l && s < E.length && (E.length = s), this && this !== ae && this instanceof _ && (R = g || pr(e)), R.apply(k, E)
                }
                return _
            }
            ...
            function Ur(e, t) {
                var r = typeof e,
                    n;
                return !!('string' == r && B.test(e) || 'number' == r) || !Pn(e) && (!K.test(e) || null != t && e in Wr(t))
            }
            ...
            function $r(e) {
                return null == e ? [] : Mr(e) ? Ye.support.unindexedChars && Un(e) ? e.split('') : Mn(e) ? e : Object(e) : Wn(e)
            }
            ...
            function mn(e, t, r, n) {
                var i = e ? Ir(e) : 0;
                return Hr(i) || (i = (e = Wn(e)).length), r = 'number' != typeof r || n && xr(t, r, n) ? 0 : r < 0 ? Ve(i + r, 0) : r || 0, 'string' == typeof e || !Pn(e) && Un(e) ? r <= i && e.indexOf(t, r) > -1 : !!i && br(e, t, r) > -1
            }
            var yn = _r(St, kt);
            ...
            function Tn(e, t, r) {
                ...
                function h(t, r) {
                    r && clearTimeout(r), i = s = c = void 0, t && (l = Sn(), o = e.apply(u, n), s || i || (n = u = void 0))
                }
                ...
                function y() {
                    if (n = arguments, a = Sn(), u = this, c = d && (s || !p), !1 === f) var r = p && !s;
                    else {
                        i || p || (l = a);
                        var v = f - (a - l),
                            h = v <= 0 || v > f;
            ...
            function Nn(e) {
                return ve(e) && Mr(e) && Ae.call(e, 'callee') && !Ce.call(e, 'callee')
            }
            var Pn = Ue || function(e) {
                return ve(e) && Hr(e.length) && be.call(e) == S
            };
            ...
            function Ln(e) {
                return null != e && (Rn(e) ? Ie.test(Te.call(e)) : ve(e) && (pe(e) ? Ie : W).test(e))
            }
            ...
            function Gn(e) {
                ...
                for (var n = e.constructor, i = -1, o = Rn(n) && n.prototype || Se, a = o === e, u = Array(t), s = t > 0, c = r.enumErrorProps && (e === Ee || e instanceof Error), l = r.enumPrototypes && Rn(e); ++i < t;) u[i] = i + '';
                for (var f in e) l && 'prototype' == f || c && ('message' == f || 'name' == f) || s && Lr(f, t) || 'constructor' == f && (a || !Ae.call(e, f)) || u.push(f);
                if (r.nonEnumShadows && e !== Se) {
                    var d = e === we ? k : e === Ee ? A : be.call(e),
                        p = Je[d] || Je[C];
    ...
    i = 'qwery', o = this, a = function() {
        ...
        function x(e) {
            for (var t = [], r = 0, n = e.length; r < n; ++r) $(e[r]) ? t = t.concat(e[r]) : t[t.length] = e[r];
            return t
        }
        ...
        function W(t) {
            return t ? 'string' == typeof t ? Q(t)[0] : !t[u] && $(t) ? t[0] : t : e
        }
